...
class ShowMessage {
    static function info($msg, $url_forward = 'goback', $ms = 1250, $dialog = '', $returnjs = ''){   
       ...
       if ($dialog)
       {
           $diglogs = '<script style="text/javascript">window.top.location.reload();</script>';
	...
	static function show_msg($show='',$url='',$dialog='',$flag=true){
		...
		if($flag) $refresh = '<meta http-equiv="refresh" content="3;url='.$url.'">';
		$msg = '<!DOCTYPE html>
				<html>
				<head>
				<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
